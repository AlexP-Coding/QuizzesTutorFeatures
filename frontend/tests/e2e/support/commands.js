...
Cypress.Commands.add('solveQuizzFailed', (quizTitle, numberOfQuizQuestions) => {
    cy.get('[data-cy="quizzesStudentMenuButton"]').click();
    cy.contains('Available').click();
    cy.contains('Failed Answers Title Sat Apr 02 2022 19:43:40 GMT+0100 (Western European Summer Time)').click();
    for (let i = 1; i < 2; i++) {
